...
Улучшил качество перевода с помощью beam search, ensembling, pivot translation и post-processing. На семинаре заметил проблему модели NLLB — она иногда повторяет символы много раз, поэтому добавил постобработку для исправления этого эффекта
Результаты:
